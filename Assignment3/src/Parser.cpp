...
namespace jgs
{
  	  ...
  	  , m_errorString("")
  {
    m_validWords = {
      ...
      Word(State::SystemMemoryState, "System"),
    ...
    DEBUG("B");
      ...
      switch(m_currentState)
      {
        ...
        case State::HDDState:
              ...
              break;
        case State::SystemMemoryState:
        		  stateSuccess = perform_SystemMemoryState();
        		  break;
  ...
  {
    DEBUG("C : The word passed is " << theWord);
    State state;
  ...
  bool Parser::perform_HDDState()
  {
    ...
    if(input == "quantity:")
    	return perform_HDDQuantityState();
  ...
  bool Parser::perform_HDDQuantityState()
  {
    m_inf >> m_configStruct.hddQuantity;
  ...
  bool Parser::perform_PrinterState()
  {
    ...
    if(input == "quantity:")
    	return perform_PrinterQuantityState();
  ...
  bool Parser::perform_PrinterQuantityState()
  {
    m_inf >> m_configStruct.printerQuantity;
    
    return true;
  
  }
  
  bool Parser::perform_SystemMemoryState()
  {
    std::string input;
    m_inf >> input;
    m_inf >> input;
    
    m_inf >> m_configStruct.memoryTotal;
  ...
  bool Parser::perform_MemoryState()
  {
    ...
    if(input == "block")
    	return perform_MemoryBlockState();
  ...
  bool Parser::perform_MemoryBlockState()
  {
  	 std::string input;
  	 ...
  	 m_inf >> m_configStruct.memoryBlockSize;
  ...
  {
     DEBUG(skippedWord);
     return true; // THIS WAS THE SOURCE OF A HUGE BUG JESUS
  }
